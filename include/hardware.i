...
| ide registers
		...
		.equ IDEBASE, 1
		.equ IDEDATA, IDEBASE+0x0
		.equ IDEERR, IDEBASE+0x1
		.equ IDEFEATURES, IDEBASE+0x1
		.equ IDECOUNT, IDEBASE+0x2
		.equ IDELBA0, IDEBASE+0x3
		.equ IDELBA1, IDEBASE+0x4
		.equ IDELBA2, IDEBASE+0x5
		.equ IDELBA3, IDEBASE+0x6
		.equ IDEHEADS, IDEBASE+0x6
		.equ IDESTATUS, IDEBASE+0x7
		.equ IDECOMMAND, IDEBASE+0x7
...
| ide status reg
		...
		.equ IDESTATUSBSY, 0x80
		.equ IDESTATUSDRDY, 0x40
		.equ IDESTATUSDWF,  0x20
		.equ IDESTATUSDSC, 0x10
		.equ IDESTATUSDRQ, 0x08
		.equ IDESTATUSCORR,  0x04
		.equ IDESTATUSIDX,  0x02
		.equ IDESTATUSERR,  0x01
