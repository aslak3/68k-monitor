...
| chain of types and data in a2. format of a2 buffer is:
|
| pairs of (type,values), ending in type=0
|
...
| zero-paddeed.
|
| on exit, a1 an a2 will point back at the start of the output buffers and a0
